...
static void drawTile(int row, int col, int type, float alpha)
{
    ...
    // Recorta o tile certo dentro da textura.
...
// Desenha o contorno do tile do cursor.
...
static void display()
{
    ...
    // Marca o tile atual com o tile rosa e um contorno.
    drawTile(curRow, curCol, 5, 0.55f);
...
// Move o cursor, sem sair dos limites do mapa.
...
// Projecao 2D: mundo do tamanho da tela, y crescendo para baixo.
